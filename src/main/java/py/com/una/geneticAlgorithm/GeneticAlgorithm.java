...
public class GeneticAlgorithm {
    ...
    public static void Combinacion_Mutación(String[][] Poblacion, String[][] PoblacionTem) {
        ...
        for (int i = 0; i < filas / 2; i++) {
            ...
            System.out.println("Punto de cruce [" + puntocruce + "][" + Poblacion[i][0] + "]"
                    + "[" + Poblacion[i][1] + "]" + "[Cruzado con] [" + Poblacion[Integer.parseInt(ParejaA)][0] + "] [" + Poblacion[Integer.parseInt(ParejaA)][1] + "]");
